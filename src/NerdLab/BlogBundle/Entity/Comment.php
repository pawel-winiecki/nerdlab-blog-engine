...
class Comment
{
    ...
    /**
     * @var \NerdLab\BlogBundle\Entity\Post
     */
    private $post;
     ...
     * Set post
     *
     * @param \NerdLab\BlogBundle\Entity\Post $post
     * @return Comment
     */
    public function setPost(\NerdLab\BlogBundle\Entity\Post $post = null)
    {
        $this->post = $post;
     ...
     * Get post
     *
     * @return \NerdLab\BlogBundle\Entity\Post 
     */
