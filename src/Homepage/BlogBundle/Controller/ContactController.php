...
use Homepage\BlogBundle\Form\Model\Message;
...
class ContactController extends Controller {
    ...
    public function contactAction(Request $request) {
        ...
        $form = $this->createFormBuilder($message)
                ->setAction($this->generateUrl('homepage_blog_contact'))
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $mail = \Swift_Message::newInstance()
                    ...
                    ->setBody(
                    $this->renderView('HomepageBlogBundle:Contact:contactEmail.html.twig', array(
        ...
        return $this->render('HomepageBlogBundle:Contact:contact.html.twig', $view);
    }
